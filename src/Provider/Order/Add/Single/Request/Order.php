...
namespace Jaddek\Kraken\Http\Client\Provider\Order\Add\Single\Request;
...
class Order implements ArrayInterface
{
    ...
    public function __construct(
         ...
         */
        private readonly EnumOperationType             $type,
         ...
         */
        private readonly ?string                       $starttm = null,
         ...
         */
        private readonly ?string                       $expiretm = null,
     ...
     */
    public function getType(): EnumOperationType
    {
        return $this->type;
    }
